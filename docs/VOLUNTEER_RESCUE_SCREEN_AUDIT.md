...
| 6 | `fa93767d86604d7f886359d445ae5904` | Mission Details | BASE | LIGHT | `mission_details_screen.dart` | `rescueMissionDetail`<br>`/rescue/missions/:missionId` | VERIFIED | VERIFIED | COMPLETE | Rescue Requests → Mission Details & Accept |
| 7 | `3c411ed9eb984aa1add0fa2ba798b73a` | Mission Accepted | BASE | LIGHT | `mission_accepted_screen.dart` | `rescueMissionAccepted`<br>`/rescue/missions/:missionId/accepted` | VERIFIED | VERIFIED | COMPLETE | Mission Details → Accept → En Route Navigation |
| 8 | `97a26f78f6d4445795807aa4f188124f` | Mission Completed | BASE | LIGHT | `mission_completed_screen.dart` | `rescueMissionCompleted`<br>`/rescue/missions/:missionId/completed` | VERIFIED | VERIFIED | COMPLETE | Mission Active → Complete Mission & Debrief |
| 9 | `a978dd78e811493d9f8a4274bed18b5f` | Rescue History | BASE | LIGHT | `rescue_history_screen.dart` | `rescueHistory`<br>`/rescue/history` | VERIFIED | VERIFIED | COMPLETE | Dashboard → Past Missions & Incident Log |
| 10 | `01b3b0f7fa0b474f99f9e66465a85f42` | Volunteer Network | BASE | LIGHT | `volunteer_network_screen.dart` | `rescueNetwork`<br>`/rescue/network` | VERIFIED | VERIFIED | COMPLETE | Dashboard → Responder Team Roster |
| 11 | `0e2764c02d7e47a882bcff2157b0b1a9` | Volunteer Profile | BASE | LIGHT | `volunteer_profile_screen.dart` | `rescueProfile`<br>`/rescue/profile` | VERIFIED | VERIFIED | COMPLETE | Nav Bar → Profile & Verification Badges |
| 12 | `5958471735044f75a7e0b65d21d67a89` | Volunteer Achievements | BASE | LIGHT | `volunteer_achievements_screen.dart` | `rescueAchievements`<br>`/rescue/achievements` | VERIFIED | VERIFIED | COMPLETE | Profile → Badges & Gamification Metrics |
| 13 | `576f66e8cefa44b1ae41b77cfd1bb38a` | Volunteer Assistance | BASE | LIGHT | `volunteer_assistance_screen.dart` | `rescueAssistance`<br>`/rescue/assistance` | VERIFIED | VERIFIED | COMPLETE | Profile / EOC → Field Support & Protocols |
| 14 | `9b1125312fa04a72bef88c32413a1be7` | Pet Sharing & Permissions | BASE | LIGHT | `pet_sharing_permissions_screen.dart` | `rescueSharing`<br>`/rescue/sharing` | VERIFIED | VERIFIED | COMPLETE | Dashboard → Foster & Emergency Access |
| 15 | `cb0ff4734475425f8f06127a1fa6b7eb` | Volunteer Settings | BASE | LIGHT | `volunteer_settings_screen.dart` | `rescueSettings`<br>`/rescue/settings` | VERIFIED | VERIFIED | COMPLETE | Profile → Alert Radius & Preferences |
