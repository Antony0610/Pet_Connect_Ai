...
void main() {
  group('RouteGuard Unit Tests', () {
    test('portalHome maps AppPortal roles to correct portal home routes', () {
      expect(RouteGuard.portalHome(AppPortal.petOwner), RoutePaths.ownerHome);
      expect(RouteGuard.portalHome(AppPortal.veterinarian), RoutePaths.vetHome);
      expect(
    ...
    test(
      ...
      () {
        ...
        expect(
          AppPortalExtension.fromDbRole('veterinarian'),
          AppPortal.veterinarian,
        );
        expect(
          AppPortalExtension.fromDbRole('volunteer_rescue'),
          AppPortal.volunteerRescue,
        );
        expect(
          AppPortalExtension.fromDbRole('administrator'),
